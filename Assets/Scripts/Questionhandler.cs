...
public class Questionhandler : UdonSharpBehaviour
{
    ...
    public void SetQuestion()
    {
        switch (Language)
        {
            case "en": Screen.text = EnglishQuestions[iterator]; break;
            case "de": Screen.text = GermanQuestions[iterator]; break;
            case "zh": Screen.text = ChineseQuestions[iterator]; break;
        }
